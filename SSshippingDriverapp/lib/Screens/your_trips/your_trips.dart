...
//import 'package:flutter_auth/Screens/home2/viewbooking.dart';
            ...
            body: ListView.separated(
              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  child: ListTile(
                    title: Text(bookings[index].Source +'----->'+ bookings[index].Destination ,style:TextStyle(color: Colors.cyan) ),
                    subtitle: Padding(
                      ...
                      child: Row(
                          ...
                          children:<Widget>[
                            ...
                            Text('Fare:   '+ bookings[index].Fare,style:TextStyle(color: Colors.green)),
                            Text('          BookingID:  '+ bookings[index].BookingID,style:TextStyle(color: Colors.green)),
